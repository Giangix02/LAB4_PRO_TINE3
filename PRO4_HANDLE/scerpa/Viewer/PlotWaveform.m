...
if isempty(in_rows) || isempty(out_rows)
    warning('Input or Output data are missing the SCERPA output file, waveform plot cannot be generated. Check "dumpDriver" and "dumpOutput" settings are set to "1" in the SCERPA input');
