...
function AuSamplePoints = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   AUSAMPLEPOINTS = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   AUSAMPLEPOINTS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   AuSamplePoints = importfile('AuSamplePoints.txt', 1, 75);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/24 17:29:27
...
AuSamplePoints = [dataArray{1:end-1}];
